...
IF DB_ID('QLCHUYENBAY') IS NOT NULL --KIỂM TRA CSDL CÓ TỒN TẠI KO?
	DROP DATABASE QLCHUYENBAY --XÓA CSDL
GO
CREATE DATABASE QLCHUYENBAY --TẠO CSDL
GO
USE QLCHUYENBAY --DÙNG CSDL 
GO
